...
class DeveloperPreview {
    ...
    let stats1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.34)
    let stats2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    let stats3 = StatisticModel(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.34)
